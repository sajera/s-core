 ...
 * @see {@link ModuleBase}
 * @param {*} ...arguments - any type and any count of arguments to deleagetet from Core.initialize( a, r, g, u, m, e, n, t, s );
 * @public
 * @class
 */
class Bootstrap extends ModuleBase {
    ...
    set root ( CustomRoot ) {
        if (
            is.function(CustomRoot)
            && (new CustomConfiguration('instanceOf')) instanceof ModuleBase
        ) {
            // store current Configuration module
