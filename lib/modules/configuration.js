...
class Configuration extends ModuleBase {
    ...
    static pathENV () {
        ...
        var env = path.join(main, '.env');
        // absolute path to config dirrectory ".env"
        var dirEnv = path.join(main, Configuration.dirName, '.env');
        // absolute path to default "{NODE_ENV||'development'}.env"
        var namedEnv = path.join(main, Configuration.envName+'.env');
        // absolute path to config dirrectory "{NODE_ENV||'development'}.env"
        var dirNamedEnv = path.join(main, Configuration.dirName, Configuration.envName+'.env');
        // choose by priority
