...
class HttpServer extends Singleton {
    ...
    /**
     * @description
        List of unique middlewares {@link HttpPoint} matchers.
     ...
     * @description
        ...
        <br/><br/>
     * @example
     * Core.HttpServer.defineEndpoint(expresion, Controller);
     * @param {HttpPoint} exspression - {@link HttpPoint}
     * @param {HttpController} Controller - {@link ControllerInterface}
     * @public
     */
    static defineEndpoint ( exspression, Controller ) {
        ...
        if (test instanceof HttpController) {
            ...
            let point = new HttpPoint(exspression, Controller);
            // add point
    ...
    middleware ( request, response ) {
        ...
        // TODO default endpoint throw undefined is not a function ((
        ...
        // start controller life cycle
        this.lifeCycle(endpoint.Controller, params, response);
    }

    /**
     * @description
        <strong> Controller life cicle </strong>
        <br/>
        <br/>
        <br/>
        <br/><br/>
     * @param {HttpController} Controller - output response
     * @param {HttpParams} params - incoming request
     * @param {Object} response - output response
     * @private
     */
    lifeCycle ( Controller, params ) {
        // TODO write life cycle of controller
        // let controler = new Controller( params );
    }
