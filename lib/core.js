...
class Core extends ModuleBase {
    ...
    static initialize ( options ) {
        ...
        handle( Bootstrap.create.bind(Bootstrap, options ) )
            .then(() => Core.logger.debug('[Core.initialize]: application was initialized') )
    ...
    static setupBootstrap ( CustomBootstrap ) {
        if (
            is.function(CustomBootstrap)            && (new CustomBootstrap('instanceOf')) instanceof Bootstrap
        ) {
