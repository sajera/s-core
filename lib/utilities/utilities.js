...
/**
 * delegate common abilities within library
...
class Utilities extends EventEmitter {
    ...
    /**
     * Method to provide ability to use for asynchronous actions "async" flow.
    ...
    /**
     * Method to provide ability to use for asynchronous actions "promise" flow.
     * <br/> Regardless of the action thread used.
     * <br/> <strong> NOTE </strong> Context binding to an action is strongly suggested.
     * <br/> Without binding action will lose the context, as any other callback function.
     * @example
    ...
    /**
     * Deffered object based on nativepromise
     * @example
