...
class Utilities extends EventEmitter {
    ...
    /**
     * outsource <strong> "async" </strong>
     * @see {@link https://www.npmjs.com/package/async|async on NPM}
     * @public
     */
    static get async () {
    ...
    /**
     * outsource <strong> "lodash" </strong>
     * @see {@link https://www.npmjs.com/package/lodash|lodash on NPM}
     * @public
     */
    static get _ () {
