...
class ErrorSpec extends ErrorInterface {
    ...
    constructor ( id, spec, error ) {
        ...
        /**
         * @desc ID of error within specification
         * @type {Number}
         * @readonly
         */
        this.id = id;
        ...
        /**
         * @desc all data from your specification
         * @type {Object}
         * @readonly
         */
        this.spec = spec;
    ...
    /**
     * @desc Example result "toJSON" method of ErrorSpec
    ...
    /**
     * @desc Define specification for Error
