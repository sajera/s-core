...
class MongooseModel extends AbstractModel {
     ...
     *
     * @param {String} schemaDefinition Optional parameter
     * @param {String} collectionName Optional parameter
     */
     ...
     * @param {String} pagination <code>pagination = {currentPage: int, pageSize: int}</code>
     * @param {String} sort Array of sortings {field: "field name", order: "asc|desc|1|-1"}
